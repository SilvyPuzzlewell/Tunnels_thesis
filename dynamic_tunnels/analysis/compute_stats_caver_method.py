...
main_program_path = "/home/ron/Bak/dynamic_tunnels/"

#here must be the tunnels found by caver be copied
caver_tunnels_path = main_program_path + "analysis/caver_tunnels"
...
caver_tunnels_path = "/home/ron/Bak/dynamic_tunnels/analysis/caver_tunnels"
caver_tunnels = os.listdir(caver_tunnels_path)
...
iterations = (glob("/home/ron/Bak/dynamic_tunnels/found_tunnels/*/"))
output_file = "stats.txt"
iteration = 0
output = open(output_file, "w")
